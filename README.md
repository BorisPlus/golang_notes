...
Изначально, в производительности "состязались" варианты Константина и Романа, которые были немного унифицированы (см. "Замечания к изменениям алгоритмов").
...
Остается только вопрос в отношении нестабильных показателей "оценки состязательности" алгоритмов главы "Нуль указатель вершины (и что все таки быстрее?)". На этом пока все.
